...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE cliente SET usuario='$nome', telefone='$telefone', endereco='$endereco', sexo='$sexo' WHERE id=$id";
  ...
  <div class="container mt-4">
    ...
    <form action="atualizar.php?id=<?php echo $id; ?>" method="POST">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nome" name="nome" value="<?php echo htmlspecialchars($cliente['usuario']); ?>" required>
      </div>
      <div class="mb-3">
